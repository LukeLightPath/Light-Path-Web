...
const App: React.FC = () => {
  ...
  if (loading || verificationState === 'verifying') {
    return (
      <div className="min-h-screen bg-[#fdfcfc] flex justify-center items-center">
        <div className="text-center">
          <svg className="mx-auto h-12 w-12 text-stone-400 animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
